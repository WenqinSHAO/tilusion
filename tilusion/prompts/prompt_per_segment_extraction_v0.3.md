...
- Prefer this concept vocabulary (novels/essays): `person`, `place`, `time_anchor`, `object`, `term`, `method`, `theme`, `motif`, `emotion`, `social_role`, `symbol`, `source`, `other`. Also accepted when needed: `group`, `organization`, `institution`, `scene_element`. The schema name for source time expressions is `time_anchor`.
- Prefer this item vocabulary (novels/essays): `event`, `action`, `statement`, `observation`, `description`, `method`, `technique`, `question`, `example`, `note`, `other`. Also accepted when needed: `scene`, `claim`, `argument`, `result`, `definition`, `limitation`, `habit`, `comparison`, `contrast`, `background`, `unresolved_issue`.
