...
- Prefer this concept vocabulary (novels/essays): `person`, `place`, `time_anchor`, `object`, `term`, `source`, `other`. Also accepted when needed: `group`, `organization`. The schema name for source time expressions is `time_anchor`.
- Prefer this item vocabulary (novels/essays): `event`, `action`, `statement`, `argument`, `observation`, `technique`, `process`, `other`. Also accepted when needed: `scene`, `claim`, `result`, `definition`, `habit`.
