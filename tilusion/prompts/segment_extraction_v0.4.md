...
- If the natural canonical name is not written in the cited text, use the written local surface form and record the canonical-looking name only in `summary` or `alias_candidate_of`.
