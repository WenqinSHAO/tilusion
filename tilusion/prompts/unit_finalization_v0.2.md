...
- Silently drop a local record just because no prior match exists. New entities, locations, and threads appear throughout a book.
...
- New entities, locations, and threads may appear that have no prior record. Create them as normal unit records.
