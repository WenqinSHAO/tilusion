...
from .extraction_payloads import (
    build_unit_finalization_payload,
    build_unit_repair_payload,
    build_unit_timeline_payload,
    build_unit_timeline_repair_payload,
)
from .extraction_prompts import (
    OVERVIEW_PROMPT_VERSION,
    PromptComposition,
    PromptPart,
    UNIT_FINALIZATION_PROMPT_VERSION,
    UNIT_REPAIR_PROMPT_VERSION,
    UNIT_TIMELINE_PROMPT_VERSION,
...
def write_unit_package(
    *,
    ...
    """Write the unit package to disk under a content-addressed run key.
