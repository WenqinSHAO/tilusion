...
def test_overview_composition_tracks_static_prompt_contract() -> None:
    ...
    assert prompt.composition_id == "overview-segmentation-v0.3"
    ...
    assert "Do not perform detailed extraction" in prompt.content
    assert "Field-language policy" in prompt.content
    assert "reader_language" in prompt.content
